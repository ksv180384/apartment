...
const props = defineProps({
  finishingType: { type: Object, default: null },
...
const form = useForm({
  name: props.finishingType?.name || '',
  slug: props.finishingType?.slug  || '',
});
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название типа отделки" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название типа отделки"/>
        </el-form-item>
      </div>
      <div class="flex-1">
