...
const props = defineProps({
  buildingClass: { type: Object, default: null },
...
const form = useForm({
  name: props.buildingClass?.name || '',
  slug: props.buildingClass?.slug  || '',
});
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название класса жилья" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название класса жилья"/>
        </el-form-item>
      </div>
      <div class="flex-1">
