...
<template>
  <el-form
    ref="refKommerceskaiaNedvizimostForm"
    :model="kommerceskaiaNedvizimostForm"
    :rules="rules"
  >
    <div>
      <div class="flex md:flex-row flex-col gap-4">
        <div class="flex-1">
          <el-form-item label="Тип" label-position="top" prop="commercial_type_id" required :error="errors?.commercial_type_id || null">
            <el-select
              v-model="kommerceskaiaNedvizimostForm.commercial_type_id"
              placeholder="Тип"
              @change="updateParent"
            >
              <el-option
        ...
        <div class="flex-1">
          <el-form-item label="Назначение" label-position="top" prop="purpose_id" required :error="errors?.purpose_id || null">
            <el-select
              v-model="kommerceskaiaNedvizimostForm.purpose_id"
        ...
        <div class="flex-1">
          <el-form-item label="Планировка" label-position="top" prop="layout_type_id" required :error="errors?.layout_type_id || null">
            <el-select
              v-model="kommerceskaiaNedvizimostForm.layout_type_id"
        ...
        <div class="flex flex-col flex-1">
          <div class="flex-1">
            <el-form-item prop="has_ventilation">
              <el-switch
                v-model="kommerceskaiaNedvizimostForm.has_ventilation"
                size="small"
                active-text="Вентиляция"
                @change="updateParent"
              />
            </el-form-item>
          </div>
          <div class="flex-1">
            <el-form-item prop="has_air_conditioning">
              <el-switch
                v-model="kommerceskaiaNedvizimostForm.has_air_conditioning"
                size="small"
                active-text="Кондиционирование"
                @change="updateParent"
              />
            </el-form-item>
          </div>
        ...
        <div class="flex flex-col flex-1">
          <div class="flex-1">
            <el-form-item prop="has_security">
              <el-switch
                v-model="kommerceskaiaNedvizimostForm.has_security"
                size="small"
                active-text="Охрана"
                @change="updateParent"
              />
          ...
          <div class="flex-1">
            <el-form-item prop="has_parking">
              <el-switch
                v-model="kommerceskaiaNedvizimostForm.has_parking"
                size="small"
