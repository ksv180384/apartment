  ...
  <div class="flex md:flex-row flex-col gap-4">
    <div class="flex-1">
      <el-form-item prop="has_utilities">
        <el-switch v-model="model.has_utilities" size="small" active-text="Коммуникации"/>
      </el-form-item>
    </div>
    <div class="flex-1">
      <el-form-item prop="has_road_access">
        <el-switch v-model="model.has_road_access" size="small" active-text="Подъездные пути"/>
      </el-form-item>
    </div>
    <div class="flex-1">
      <el-form-item prop="has_fence">
        <el-switch v-model="model.has_fence" size="small" active-text="Ограждение"/>
      </el-form-item>
    </div>
  </div>
</div>
