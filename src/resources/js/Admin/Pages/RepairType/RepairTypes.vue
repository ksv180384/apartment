...
const deleteItem = (id) => {
  router.delete(route('admin.repair_types.destroy', { id: id }), {
    onSuccess: () => {
...
<template>
  <Head title="Список типов ремонта" />

  <AdminLayout header-title="Список типов ремонта">
    <div class="flex justify-between py-3">
      ...
      <div>
        <el-link type="success" class="![position:initial]">
          <Link :href="route('admin.repair_types.create')">
