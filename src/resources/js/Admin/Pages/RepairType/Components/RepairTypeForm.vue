...
const props = defineProps({
  repairType: { type: Object, default: null },
...
const form = useForm({
  name: props.repairType?.name || '',
  slug: props.repairType?.slug  || '',
});
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название типа ремонта" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название типа ремонта"/>
        </el-form-item>
      </div>
      <div class="flex-1">
