...
const props = defineProps({
  layoutType: { type: Object, default: null },
...
const form = useForm({
  name: props.layoutType?.name || '',
  slug: props.layoutType?.slug  || '',
});
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название планировки" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название планировки"/>
        </el-form-item>
      </div>
      <div class="flex-1">
