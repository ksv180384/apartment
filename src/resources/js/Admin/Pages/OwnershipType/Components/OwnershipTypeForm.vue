...
const props = defineProps({
  ownershipType: { type: Object, default: null },
...
const form = useForm({
  name: props.ownershipType?.name || '',
  slug: props.ownershipType?.slug  || '',
});
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название формы собственности" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название формы собственности"/>
        </el-form-item>
      </div>
      <div class="flex-1">
