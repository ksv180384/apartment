...
const props = defineProps({
  buildingType: { type: Object, default: null },
...
>
  <div class="flex flex-col">
    <div class="flex md:flex-row flex-col gap-4">
      <div class="flex-1">
        <el-form-item label="Название типа дома" label-position="top" prop="name" required :error="errors?.name || null">
          <el-input ref="refInputName" v-model="form.name" placeholder="Название типа дома"/>
        </el-form-item>
      </div>
      <div class="flex-1">
